      ...
      <div className="row mt-0 mx-lg-5 text-start col-12 p-lg-5 mx-2">
        ...
        <div className="col-md-4 mb-4" data-aos="fade-right">
          ...
          >
            ...
            IoT Software & Application Development
          </h5>
          <p
            className="text-white"
            style={{ fontSize: "clamp(13px, 2.2vw, 16px)", lineHeight: "150%" }}
          >
            We use our expertise in web and mobile app development to build the front-end applications that allow you to manage, control, and visualize data from all your IoT device.
          </p>
        </div>
        ...
        <div className="col-md-4 mb-4" data-aos="fade-up">
          ...
          <p
            ...
            style={{ fontSize: "clamp(13px, 2.2vw, 16px)", lineHeight: "150%" }}
          >
           Our cloud computing and DevOps skills are used to create the secure and scalable cloud infrastructure needed to store the massive amounts of data generated by your IoT systems.
          </p>
        </div>
        ...
        <div className="col-md-4 mb-4" data-aos="fade-left">
          ...
          <p
            ...
            style={{ fontSize: "clamp(13px, 2.2vw, 16px)", lineHeight: "150%" }}
          >
            We apply our data science and machine learning expertise to transform raw IoT data into actionable business intelligence, helping you identify trends, optimize processes, and make smarter decisions.
          </p>
        </div>
